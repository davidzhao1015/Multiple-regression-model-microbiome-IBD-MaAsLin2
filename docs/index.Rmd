...
## MaAsLin2
[MaAsLin2](https://github.com/biobakery/biobakery/wiki/maaslin2) is to efficiently determine multivariable association between phenotypes, environments, exposures, covariates and microbial meta-omics features.
...
fit_data2 <- Maaslin2(
        ...
        reference = c("diagnosis,nonIBD")) #set baseline for the categorical variable, diagnosis 
